...
plot(hpc$DateTime, hpc$Voltage, type = "n", xlab = "datetime", ylab = "Voltage")
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"), col = c("black","red","blue"), lty=c(1,1,1), cex=0.5, pt.cex = 3, bty ='n')
